  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex min-h-12 min-w-12 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-2 w-[calc(100vw-2rem)] rounded-xl border border-border bg-white shadow-lg sm:w-[360px]">
          {/* Header */}
