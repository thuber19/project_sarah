...
const optimizedQuerySchema = z.object({
  apolloParams: z.object({
    ...
    personSeniorities: z
      .array(z.string())
      .describe(
        'Apollo seniority levels: owner, founder, c_suite, vp, director, manager, senior, entry',
      ),
    organizationSizes: z
      .array(z.string())
      .describe('Apollo ranges: 1-10, 11-50, 51-200, 201-500, 501-1000, 1001-5000, 5001+'),
    ...
    organizationKeywords: z
      .array(z.string())
      .describe('Relevante Keywords für die Zielunternehmen'),
    organizationTechnologies: z
      .array(z.string())
      .optional()
      .describe('Technologien die Zielunternehmen nutzen'),
  }),
  googlePlacesQueries: z
    .array(
      z.object({
